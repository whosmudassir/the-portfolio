...
const SkillsCard = () => {
  return (
    <div
      ...
      className="h-full bg-[#f8f8f8] w-full rounded-lg cursor-pointer hover:scale-95 transform transition duration-500 ease-in-out flex  flex-col items-center justify-center p-[10px]"
