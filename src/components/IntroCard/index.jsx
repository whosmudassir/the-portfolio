...
const Card = () => {
  ...
  return (
    <div
      ...
      className="h-[300px] bg-[#f8f8f8] w-full  rounded-2xl cursor-pointer hover:scale-95 transform transition duration-500 ease-in-out flex items-center justify-around p-[30px]"
